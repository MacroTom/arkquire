...
<template>
    ...
    <nav class="sticky top-0 z-30 items-center justify-between hidden w-full h-20 border-b lg:flex trans md:px-8 lg:px-16 backdrop-blur">
        ...
        <div class="flex items-center gap-4">
            <button v-badge class="flex items-center justify-center w-10 h-10 border rounded-lg p-overlay-badge">
                <i class="text-xl bx bx-bell bx-tada"></i>
            </button>
            <div class="h-10 border-l"></div>
            <div class="flex items-center h-10 gap-3">
                <Avatar image="https://via.placeholder.com/320x320.png/001155?text=people+asperiores"
                  shape="circle" />
                <div class="flex flex-col items-start">
                    <p class="text-sm font-semibold text-neutral-800">Esieba Okeoghene</p>
                    <small class="text-xs text-neutral-800">okeesieba@gmail.com</small>
                </div>
            </div>
        </div>
    </nav>
