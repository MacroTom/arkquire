        ...
        <section v-if="screen == 'Register'">
            ...
            <div class="w-full grid grid-cols-2 gap-3">
                <div class="w-full mb-2">
                    ...
                    <Password :class="$page?.props?.errors?.password && 'p-invalid'" class="w-full p-inputtext-sm" v-model="form.password" toggleMask aria-describedby="text-error"/>
                ...
                <div class="w-full mb-4">
                    ...
                    <Password :class="$page?.props?.errors?.password_confirm && 'p-invalid'" class="w-full p-inputtext-sm" v-model="form.password_confirm" toggleMask aria-describedby="text-error"/>
